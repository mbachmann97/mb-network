...
In mb-network Ip's are stored as a single number. To covert them to the well known readable format e.g. 192.168.0.1 you need to use the function *ipToString*.
